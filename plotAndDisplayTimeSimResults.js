function plotAndDisplayTimeSimResults(
  i1,
  i2,
  sw1,
  VDC,
  ...
  let fallingEdge = 0.125 * tvec.length;
  ...
  solverMessage = "Optimizer's least squares error= " + F;

  efficiencyMessage = "Efficiency = " + efficiency.toFixed(5);
  outputVoltageMessage = "Output (load) voltage = " + VDC.toFixed(5) + " VDC";
